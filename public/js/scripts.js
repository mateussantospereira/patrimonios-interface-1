...
async function sendFetch(route, method, body, compare = undefined) {
...
async function fetchRedirect(route, method, body, redirect, compare = undefined) {
...
function formHTML(head, reqData) {
    ...
    formText = formText + `
        <div class="center">
            <button class="primary">Atualizar</button><br><br>
        </div>
    `;
